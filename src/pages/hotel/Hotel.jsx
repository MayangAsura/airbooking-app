...
const Hotel = () => {
  ...
  const rooms = useFetch(`/hotels/rooms/${id}`);
  const { user } = useContext(AuthContext);
  const navigate = useNavigate();

  const { dates, options } = useContext(SearchContext);
  console.log(data, dates, options)
  ...
  return (
    <div>
          ...
          <div className="hotelWrapper">
            ...
            <div className="hotelDetails">
              ...
              <div className="hotelDetailsPrice">
                ...
                <h2>
                  <b>${days * data.data?.cheapestPrice * options.room}</b> ({days}{" "}
                  nights)
                </h2>
      ...
      {openModal && <Reserve setOpen={setOpenModal} hotelId={id} hotelRooms={rooms.data} />}
    </div>
  );
};
